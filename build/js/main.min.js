...
window.addEventListener('DOMContentLoaded', function () {
  var acc = document.querySelectorAll('.accordion__item');

  for (var i = 0; i < acc.length; i++) {
    acc[i].classList.remove('accordion__item--nojs');

    acc[i].onclick = function () {
      var setClasses = !this.classList.contains('accordion__item--show');
  ...
  var btnText = document.querySelector('.about-company__button');
  var breakText = document.querySelector('.about-company__break-text');
  var moreTextMobile = document.querySelector('.about-company__more--mobile-only');
  var moreTextTablet = document.querySelector('.about-company__more--tablet');
  var moreTextTablet2 = document.querySelector('.about-company__more--tablet-2');
  ...
  btnText.addEventListener('click', readMore); // Маска телефона
  ...
  for (var _i2 = 0; _i2 < phoneInputs.length; _i2++) {
    var input = phoneInputs[_i2];
  ...
  if (window.localStorage) {
    ...
    for (var _i3 = 0, length = elements.length; _i3 < length; _i3++) {
      (function (element) {
  ...
  window.addEventListener('load', function () {
    ...
    var inputName = modal.querySelector('#modal-user-name');
